...
import io.github.flemmli97.improvedmobs.industrial.SporeApiDiagnostics;
    ...
    private static int toggleSporeDebug(CommandContext<CommandSourceStack> ctx) {
        try {
            ...
            String messageKey = TriAxisConfig.enableSporeDebug ?
                    "improvedmobs.command.spore.debug.enabled" :
                    "improvedmobs.command.spore.debug.disabled";
