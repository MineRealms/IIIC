package io.github.flemmli97.improvedmobs.mekanism_turrets.client.gui;
...
import io.github.flemmli97.improvedmobs.mekanism_turrets.common.packet.ModifyTurretTargetPacket;
...
public class LaserTurretScreen extends GuiMekanismTile<LaserTurretBlockEntity, MekanismTileContainer<LaserTurretBlockEntity>> {
    ...
    private static final ResourceLocation TARGET_HOSTILE_OFF = new ResourceLocation(ImprovedMobs.MODID, "textures/gui/target_hostile_off.png");
    private static final ResourceLocation TARGET_HOSTILE_ON = new ResourceLocation(ImprovedMobs.MODID, "textures/gui/target_hostile_on.png");
    private static final ResourceLocation TARGET_PASSIVE_OFF = new ResourceLocation(ImprovedMobs.MODID, "textures/gui/target_passive_off.png");
    private static final ResourceLocation TARGET_PASSIVE_ON = new ResourceLocation(ImprovedMobs.MODID, "textures/gui/target_passive_on.png");
    private static final ResourceLocation TARGET_PLAYER_OFF = new ResourceLocation(ImprovedMobs.MODID, "textures/gui/target_players_off.png");
    private static final ResourceLocation TARGET_PLAYER_ON = new ResourceLocation(ImprovedMobs.MODID, "textures/gui/target_players_on.png");
    private static final ResourceLocation TARGET_TRUSTED_OFF = new ResourceLocation(ImprovedMobs.MODID, "textures/gui/target_trusted_off.png");
    private static final ResourceLocation TARGET_TRUSTED_ON = new ResourceLocation(ImprovedMobs.MODID, "textures/gui/target_trusted_on.png");
