package io.github.flemmli97.improvedmobs.mekanism_turrets.client.model;
import io.github.flemmli97.improvedmobs.ImprovedMobs;

import io.github.flemmli97.improvedmobs.mekanism_turrets.common.block.LaserTurretBlock;
...
public class LaserTurretModel extends DefaultedBlockGeoModel<LaserTurretBlockEntity> {
    ...
    private static final ResourceLocation MODEL_BASIC = new ResourceLocation(ImprovedMobs.MODID, "geo/block/basic_laser_turret.geo.json");
    private static final ResourceLocation MODEL_ADVANCED = new ResourceLocation(ImprovedMobs.MODID, "geo/block/advanced_laser_turret.geo.json");
    private static final ResourceLocation MODEL_ELITE = new ResourceLocation(ImprovedMobs.MODID, "geo/block/elite_laser_turret.geo.json");
    private static final ResourceLocation MODEL_ULTIMATE = new ResourceLocation(ImprovedMobs.MODID, "geo/block/ultimate_laser_turret.geo.json");

    private static final ResourceLocation TEXTURE_BASIC = new ResourceLocation(ImprovedMobs.MODID, "textures/block/basic_laser_turret.png");
    private static final ResourceLocation TEXTURE_ADVANCED = new ResourceLocation(ImprovedMobs.MODID, "textures/block/advanced_laser_turret.png");
    private static final ResourceLocation TEXTURE_ELITE = new ResourceLocation(ImprovedMobs.MODID, "textures/block/elite_laser_turret.png");
    private static final ResourceLocation TEXTURE_ULTIMATE = new ResourceLocation(ImprovedMobs.MODID, "textures/block/ultimate_laser_turret.png");

    private static final ResourceLocation ANIMATION_BASIC = new ResourceLocation(ImprovedMobs.MODID, "animations/block/basic_anim.json");
    private static final ResourceLocation ANIMATION_ADVANCED = new ResourceLocation(ImprovedMobs.MODID, "animations/block/advanced_anim.json");
    private static final ResourceLocation ANIMATION_ELITE = new ResourceLocation(ImprovedMobs.MODID, "animations/block/elite_anim.json");
    private static final ResourceLocation ANIMATION_ULTIMATE = new ResourceLocation(ImprovedMobs.MODID, "animations/block/ultimate_anim.json");
    public LaserTurretModel() {
        super(new ResourceLocation(ImprovedMobs.MODID, "laser_turret"));
    }
