...
public class GameStageCalculator {
    ...
    public enum PollutionLevel {
        SAFE("improvedmobs.pollution.safe", 0.0, 0.15),
        LIGHT("improvedmobs.pollution.light", 0.15, 0.30),
        MODERATE("improvedmobs.pollution.moderate", 0.30, 0.50),
        HIGH("improvedmobs.pollution.high", 0.50, 0.70),
        SEVERE("improvedmobs.pollution.severe", 0.70, 0.90),
        CATASTROPHIC("improvedmobs.pollution.catastrophic", 0.90, Double.MAX_VALUE);
