...
import io.github.flemmli97.improvedmobs.client.hud.DifficultyHudData;
    ...
    public static void handle(SyncHudDataPacket packet, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            if (mc.player != null) {
                ...
                if (io.github.flemmli97.improvedmobs.industrial.IndustrialLogger.isDebugEnabled()) {
                    io.github.flemmli97.improvedmobs.industrial.IndustrialLogger.info(String.format(
