...
public class DamageTypeRegistry {
    ...
    public DamageTypeRegistry(RegistryAccess registryAccess) {
        ...
        this.electricFence = source(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(IntegratedIndustrialCraft.MODID, "electric_fence")));
        this.laser = source(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(IntegratedIndustrialCraft.MODID, "laser")));
    }
