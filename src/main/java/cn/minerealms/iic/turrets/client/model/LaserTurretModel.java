...
public class LaserTurretModel extends DefaultedBlockGeoModel<LaserTurretBlockEntity> {
    ...
    private static final ResourceLocation MODEL_BASIC = new ResourceLocation(IntegratedIndustrialCraft.MODID, "geo/block/basic_laser_turret.geo.json");
    private static final ResourceLocation MODEL_ADVANCED = new ResourceLocation(IntegratedIndustrialCraft.MODID, "geo/block/advanced_laser_turret.geo.json");
    private static final ResourceLocation MODEL_ELITE = new ResourceLocation(IntegratedIndustrialCraft.MODID, "geo/block/elite_laser_turret.geo.json");
    private static final ResourceLocation MODEL_ULTIMATE = new ResourceLocation(IntegratedIndustrialCraft.MODID, "geo/block/ultimate_laser_turret.geo.json");

    private static final ResourceLocation TEXTURE_BASIC = new ResourceLocation(IntegratedIndustrialCraft.MODID, "textures/block/basic_laser_turret.png");
    private static final ResourceLocation TEXTURE_ADVANCED = new ResourceLocation(IntegratedIndustrialCraft.MODID, "textures/block/advanced_laser_turret.png");
    private static final ResourceLocation TEXTURE_ELITE = new ResourceLocation(IntegratedIndustrialCraft.MODID, "textures/block/elite_laser_turret.png");
    private static final ResourceLocation TEXTURE_ULTIMATE = new ResourceLocation(IntegratedIndustrialCraft.MODID, "textures/block/ultimate_laser_turret.png");

    private static final ResourceLocation ANIMATION_BASIC = new ResourceLocation(IntegratedIndustrialCraft.MODID, "animations/block/basic_anim.json");
    private static final ResourceLocation ANIMATION_ADVANCED = new ResourceLocation(IntegratedIndustrialCraft.MODID, "animations/block/advanced_anim.json");
    private static final ResourceLocation ANIMATION_ELITE = new ResourceLocation(IntegratedIndustrialCraft.MODID, "animations/block/elite_anim.json");
    private static final ResourceLocation ANIMATION_ULTIMATE = new ResourceLocation(IntegratedIndustrialCraft.MODID, "animations/block/ultimate_anim.json");
    public LaserTurretModel() {
        super(new ResourceLocation(IntegratedIndustrialCraft.MODID, "laser_turret"));
    }
